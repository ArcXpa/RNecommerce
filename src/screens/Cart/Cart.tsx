                ...
                <>
                  ...
                  <View style={[layout.row, gutters.marginBottom_24]}>
                    <FlatList
                      ...
                      showsHorizontalScrollIndicator={false}
                      data={RECCDATA}
                      renderItem={({ item }) => <RecItem title={item.title} />}
                  ...
                  >
                    ...
                    >
                      ...
                      <Text style={[styles.lbl_info, gutters.marginLeft_26, layout.flex_1]}>
                        By placing an order you agree to our <Text style={{color:'black'}}>Terms</Text> and
                        <Text style={{color:'black'}}> Conditions</Text>
                      </Text>
                    </View>
                  </TouchableOpacity>

                  <TouchableOpacity style={[gutters.marginTop_16,]} onPress={()=>{
